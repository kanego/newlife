...
import  com.example.xingxingguo.locallife.netutil.GetBitmapUtil;
...
public class NewsListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(R.mipmap.img_temp);
    ...
    public class MyAsyncTaskGetBitmap extends AsyncTask<String, String, Bitmap> {
        ImageView imageView ;
        //照片标志，由于imageview的重用，可能被其他item占用，导致获取的imageview的图片和item不和。
        // 这里设一个标志如果tag和imageView.getTag()相同说明该imagevIEW还没有被重用
        String targetUrl;
        @Override
